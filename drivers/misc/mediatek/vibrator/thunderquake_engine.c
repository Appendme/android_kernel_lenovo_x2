...
static ssize_t vibr_vtg_show(struct kobject *kobj, struct kobj_attribute *attr,
							char *buf)
{
...
static ssize_t vibr_vtg_store(struct kobject *kobj, struct kobj_attribute *attr,
